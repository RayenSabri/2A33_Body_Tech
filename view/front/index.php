...
<head>
  ...
  <body>
    ...
    ?>
    <script>alert('Email successfully sent to us  your car will be added to our site as much as possible, cordially ');</script>
    <?php
    }
    ?>
        ...
        <div class="row">
            <div class="col-md-6 text-center text-lg-left mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center">
                    ...
                    <a class="text-body px-3" href=""><i class="fa fa-envelope mr-2"></i>carrent@yandex.com</a>
                </div>
            </div>
            <div class="col-md-6 text-center text-lg-right">
                <div class="d-inline-flex align-items-center">
                    ...
                    <span class="text-body">|</span>
                        <a href="about.html" class="nav-item nav-link">Connexion</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu rounded-0 m-0">
                                ...
                                <a href="addcar.php" class="dropdown-item">car add</a>
                            </div>
                        </div>
                        <div class="nav-item dropdown">
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
           <!-- <h1 class="display-1 text-primary text-center">01</h1>  -->
            <h1 class="display-4 text-uppercase text-center mb-5">Welcome To <span class="text-primary">CARRENT</span></h1>
                ...
                <div class="col-lg-6 px-0">
                    <div class="px-5 bg-secondary d-flex align-items-center justify-content-between" style="height: 350px;">
                        ...
                        <div class="text-right">
                            <h3 class="text-uppercase text-light mb-3">Pour Avoir Une Mercedes </h3>
                            <p class="mb-4">Avec Des Raisonables Prix</p>
                            <a class="btn btn-primary py-2 px-4" href="">Reserver Maintenant !</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 px-0">
                    <div class="px-5 bg-dark d-flex align-items-center justify-content-between" style="height: 350px;">
                        <div class="text-left">
                            <h3 class="text-uppercase text-light mb-3">Cherchez-Vous Une Voiture?</h3>
                            <p class="mb-4">Votre Voiture Vous Attend</p>
                            <a class="btn btn-primary py-2 px-4" href="">Reserver Maintenant !</a>
                        </div>
    ...
    <div class="container-fluid bg-secondary py-5 px-sm-3 px-md-5" style="margin-top: 90px;">
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt text-white mr-3"></i>PETITE ARIANA</p>
