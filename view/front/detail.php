        ...
        <div class="container pb-5">
            ...
            <div class="owl-carousel related-carousel position-relative" style="padding: 0 30px;">
                <div class="rent-item">
                    ...
                    <a class="btn btn-primary px-3" href="">90.00TD/Day</a>
                </div>
                <div class="rent-item">
                    ...
                    <a class="btn btn-primary px-3" href="">90.00DT/Day</a>
                </div>
                <div class="rent-item">
    ...
    <div class="container-fluid bg-secondary py-5 px-sm-3 px-md-5" style="margin-top: 90px;">
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p><i class="fa fa-envelope text-white mr-3"></i>carrent@yandexcom</p>
