...
$liste = $voitureC->afficher_Voiture(); // appel ftio affichage
        ...
        <div class="container pt-5 pb-3">
            ...
            <?php
                    ...
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="<?php echo $car['photo']; ?>" alt="">
                        <h4 class="text-uppercase mb-4"><?php echo $car['marque']; ?></h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                                <i class="fa fa-car text-primary mr-1"></i>
                                <span><?php echo $car['etat']; ?></span>
                            </div>
                            ...
                            <div class="px-2">
                                ...
                                <span><?php echo $car['kilometrage']; ?></span>
                            </div>
                        </div>
                        <a class="btn btn-primary px-3" href=""><?php echo $car['prix']; ?></a>
                    </div>
                </div>
                        <?php
                        }
