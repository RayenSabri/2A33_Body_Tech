                                ...
                                <form method="post" action="" id="form" onsubmit="event.preventDefault(); verif();">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                <label>id_of</label>
                                                <select class="form-control" name="id_of">
                                                    <?php
                                                    foreach ($liste as $offre) {
                                                    ?>
                                                    <option value="<?php echo $offre["id"]?>"><?php echo $offre["id"]?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                <label>id_ur</label>
                                                <input type="text" class="form-control" name="id_ur" id="id_ur" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <a href="ListInscription.php" class="btn btn-danger">Annuler</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
