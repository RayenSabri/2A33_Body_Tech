...
$liste = $offreC->rechercheOffre($recherche);
if (isset($_POST['tri'])) {
  $tri = $_POST['tri'];
  switch ($tri) {
    case 'croissant':
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Offres <small>Voici nos Offres</small></h3>
              </div>

              <div class="title_right">
                <div class="col-md- col-sm-5 col-xs-12 form-group pull-right top_search">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <table class="table table-hover">
                      ...
                      foreach ($liste as $offre){
                        ...
                        <tr>
                          ...
                          <td><?php echo $offre['prix']; ?></td>
                          <td><?php echo $offre['date']; ?></td>
                          <td>
                            <a href="deleteOffre.php?id=<?php echo $offre['id']; ?>" class="btn btn-danger">Supprimer</a>
                            <a href="updateOffre1.php?id=<?php echo $offre['id']; ?>" class="btn btn-warning">Modifier</a>
                ...
                <tr>
                  <td>
                    <a href="addOffre2.php" class="btn btn-primary">Ajouter</a>
                  </td>
              </div>
